...
class AddColumnTable(ModelView):
    ...
    def index(self):
        ...
        for item in listQuery:
            SendRequest("https://sqs.us-east-1.amazonaws.com/474241146212/AddNewColumnTable", item)
...
class RenameColumnTableView(ModelView):
    ...
    def details(self):
        ...
        if request.method == "POST":
            ...
            SendRequest("https://sqs.us-east-1.amazonaws.com/474241146212/AddNewColumnTable", query)
            return redirect(url_for('_user.index'))
