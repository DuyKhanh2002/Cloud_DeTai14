...
class SubmitUserManageTableView(BaseView):
    ...
    def index(self):
        ...
        if request.method == "POST":
            url = "https://sqs.us-east-1.amazonaws.com/799888255921/queueCreateTableDatabase"
            headers = {"Content-Type": "application/x-www-form-urlencoded"}
...
class AddColumnTable(ModelView):
    ...
    def index(self):
        ...
        for item in listQuery:
            SendRequest("https://sqs.us-east-1.amazonaws.com/799888255921/queueAddNewColumnTable", item)
...
class RenameColumnTableView(ModelView):
    ...
    def details(self):
        ...
        if request.method == "POST":
            ...
            SendRequest("https://sqs.us-east-1.amazonaws.com/799888255921/queueAddNewColumnTable", query)
            return redirect(url_for('_user.index'))
...
class SubmitEditDataTable(ModelView):
    ...
    def details(self):
        ...
        SendRequest("https://sqs.us-east-1.amazonaws.com/799888255921/queueEditDataTable", decodeQuery)
...
class SubmitDeleteDataTable(ModelView):
    ...
    def details(self):
        ...
        decodeQuery = query.replace("'", "$")
        SendRequest("https://sqs.us-east-1.amazonaws.com/799888255921/queueDeleteDataTable", decodeQuery)
...
class SubmitDropTable(ModelView):
    ...
    def details(self):
        ...
        SendRequest("https://sqs.us-east-1.amazonaws.com/799888255921/queueDropTable", query)
        return redirect(request.referrer)
...
class SubmitDropDatabase(ModelView):
    ...
    def submit(self):
        ...
        SendRequest("https://sqs.us-east-1.amazonaws.com/799888255921/queueDropDatabase", getName)
        return redirect(url_for('_user.index'))
